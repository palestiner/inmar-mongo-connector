...
public class IncrementalDumpMessageProcessorDebuggable
    extends IncrementalDumpMessageProcessor
    implements DebugInfoProvider
{


    public IncrementalDumpMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("incrementalTimestampFile", "Incremental timestamp file", (java.lang.String.class), incrementalTimestampFile, muleEvent));
