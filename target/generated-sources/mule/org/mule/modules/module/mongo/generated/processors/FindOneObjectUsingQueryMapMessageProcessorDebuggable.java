...
public class FindOneObjectUsingQueryMapMessageProcessorDebuggable
    extends FindOneObjectUsingQueryMapMessageProcessor
    implements DebugInfoProvider
{


    public FindOneObjectUsingQueryMapMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("failOnNotFound", "Fail on not found", (java.lang.Boolean.class), failOnNotFound, muleEvent));
