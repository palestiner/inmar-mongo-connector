...
public class RestoreMessageProcessorDebuggable
    extends RestoreMessageProcessor
    implements DebugInfoProvider
{


    public RestoreMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("drop", "Drop", (boolean.class), drop, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("inputPath", "Input path", (java.lang.String.class), inputPath, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("oplogReplay", "Oplog replay", (boolean.class), oplogReplay, muleEvent));
