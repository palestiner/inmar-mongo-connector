...
public class DropDatabaseMessageProcessorDebuggable
    extends DropDatabaseMessageProcessor
    implements DebugInfoProvider
{


    public DropDatabaseMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
