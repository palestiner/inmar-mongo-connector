...
public class FindOneFileMessageProcessorDebuggable
    extends FindOneFileMessageProcessor
    implements DebugInfoProvider
{


    public FindOneFileMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
