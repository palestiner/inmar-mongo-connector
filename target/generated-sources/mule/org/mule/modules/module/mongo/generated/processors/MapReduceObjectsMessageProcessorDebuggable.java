...
public class MapReduceObjectsMessageProcessorDebuggable
    extends MapReduceObjectsMessageProcessor
    implements DebugInfoProvider
{


    public MapReduceObjectsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("mapFunction", "Map function", (java.lang.String.class), mapFunction, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("collection", "Collection", (java.lang.String.class), collection, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("outputCollection", "Output collection", (java.lang.String.class), outputCollection, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("reduceFunction", "Reduce function", (java.lang.String.class), reduceFunction, muleEvent));
