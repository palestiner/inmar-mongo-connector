...
public class DropIndexMessageProcessorDebuggable
    extends DropIndexMessageProcessor
    implements DebugInfoProvider
{


    public DropIndexMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("index", "Index", (java.lang.String.class), index, muleEvent));
