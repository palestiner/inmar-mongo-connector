...
public class RemoveObjectsMessageProcessorDebuggable
    extends RemoveObjectsMessageProcessor
    implements DebugInfoProvider
{


    public RemoveObjectsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
