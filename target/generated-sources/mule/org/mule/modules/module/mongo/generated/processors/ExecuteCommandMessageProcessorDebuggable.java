...
public class ExecuteCommandMessageProcessorDebuggable
    extends ExecuteCommandMessageProcessor
    implements DebugInfoProvider
{


    public ExecuteCommandMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("commandName", "Command name", (java.lang.String.class), commandName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("commandValue", "Command value", (java.lang.String.class), commandValue, muleEvent));
