...
public class FindObjectsUsingQueryMapMessageProcessorDebuggable
    extends FindObjectsUsingQueryMapMessageProcessor
    implements DebugInfoProvider
{


    public FindObjectsUsingQueryMapMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("queryAttributes", "Query attributes", (java.util.Map.class), queryAttributes, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("numToSkip", "Num to skip", (java.lang.Integer.class), numToSkip, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("limit", "Limit", (java.lang.Integer.class), limit, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("sortBy", "Sort by", (com.mongodb.DBObject.class), sortBy, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("collection", "Collection", (java.lang.String.class), collection, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("fields", "Fields", (java.util.List.class), fields, muleEvent));
