...
public class DropCollectionMessageProcessorDebuggable
    extends DropCollectionMessageProcessor
    implements DebugInfoProvider
{


    public DropCollectionMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
