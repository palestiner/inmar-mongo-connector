...
public class UpdateObjectsMessageProcessorDebuggable
    extends UpdateObjectsMessageProcessor
    implements DebugInfoProvider
{


    public UpdateObjectsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
