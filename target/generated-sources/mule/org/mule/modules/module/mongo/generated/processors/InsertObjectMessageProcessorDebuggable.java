...
public class InsertObjectMessageProcessorDebuggable
    extends InsertObjectMessageProcessor
    implements DebugInfoProvider
{


    public InsertObjectMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("dbObject", "Db object", (com.mongodb.DBObject.class), dbObject, muleEvent));
