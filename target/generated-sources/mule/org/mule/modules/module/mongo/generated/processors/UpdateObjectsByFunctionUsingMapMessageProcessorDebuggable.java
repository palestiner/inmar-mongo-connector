...
public class UpdateObjectsByFunctionUsingMapMessageProcessorDebuggable
    extends UpdateObjectsByFunctionUsingMapMessageProcessor
    implements DebugInfoProvider
{


    public UpdateObjectsByFunctionUsingMapMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("elementAttributes", "Element attributes", (java.util.Map.class), elementAttributes, muleEvent));
