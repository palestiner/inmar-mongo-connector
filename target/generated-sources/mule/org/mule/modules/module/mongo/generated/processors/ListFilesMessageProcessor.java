...
/**
 * ListFilesMessageProcessor invokes the {@link org.mule.modules.module.mongo.MongoCloudConnector#listFiles(com.mongodb.DBObject)} method in {@link MongoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MongoCloudConnector at listFiles retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
