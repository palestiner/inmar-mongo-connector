...
public class CreateIndexMessageProcessorDebuggable
    extends CreateIndexMessageProcessor
    implements DebugInfoProvider
{


    public CreateIndexMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("order", "Order", (org.mule.modules.module.mongo.api.IndexOrder.class), order, muleEvent));
