...
public class CreateFileFromPayloadMessageProcessorDebuggable
    extends CreateFileFromPayloadMessageProcessor
    implements DebugInfoProvider
{


    public CreateFileFromPayloadMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("metadata", "Metadata", (com.mongodb.DBObject.class), metadata, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("filename", "Filename", (java.lang.String.class), filename, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("payload", "Payload", (java.lang.Object.class), payload, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("contentType", "Content type", (java.lang.String.class), contentType, muleEvent));
