    ...
    implements DebugInfoProvider
{
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("size", "Size", (java.lang.Integer.class), size, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("capped", "Capped", (boolean.class), capped, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("collection", "Collection", (java.lang.String.class), collection, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("maxObjects", "Max objects", (java.lang.Integer.class), maxObjects, muleEvent));
