...
public class DumpMessageProcessorDebuggable
    extends DumpMessageProcessor
    implements DebugInfoProvider
{


    public DumpMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("zip", "Zip", (boolean.class), zip, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("outputName", "Output name", (java.lang.String.class), outputName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("oplog", "Oplog", (boolean.class), oplog, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("threads", "Threads", (int.class), threads, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("outputDirectory", "Output directory", (java.lang.String.class), outputDirectory, muleEvent));
