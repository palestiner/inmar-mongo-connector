...
public class CountObjectsMessageProcessorDebuggable
    extends CountObjectsMessageProcessor
    implements DebugInfoProvider
{


    public CountObjectsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
