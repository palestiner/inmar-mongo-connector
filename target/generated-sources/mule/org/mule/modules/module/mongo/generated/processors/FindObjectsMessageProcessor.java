...
/**
 * FindObjectsMessageProcessor invokes the {@link org.mule.modules.module.mongo.MongoCloudConnector#findObjects(java.lang.String, com.mongodb.DBObject, java.util.List, java.lang.Integer, java.lang.Integer, com.mongodb.DBObject)} method in {@link MongoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final DBObject _transformedSortBy = ((DBObject) evaluateAndTransform(getMuleContext(), event, FindObjectsMessageProcessor.class.getDeclaredField("_sortByType").getGenericType(), null, sortBy));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MongoCloudConnector) object).findObjects(_transformedCollection, _transformedQuery, _transformedFields, _transformedNumToSkip, _transformedLimit, _transformedSortBy);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MongoCloudConnector at findObjects retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
