...
public class AddUserMessageProcessorDebuggable
    extends AddUserMessageProcessor
    implements DebugInfoProvider
{


    public AddUserMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("newUsername", "New username", (java.lang.String.class), newUsername, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("newPassword", "New password", (java.lang.String.class), newPassword, muleEvent));
